...
def r_value():
    ...
    gauge_msg_diff_detail = Gauge("rocketmq_msg_diff_detail", "message count that not be consumed.", ['topic', 'consumerGroup', 'broker', 'queueId', 'consumerClientIP', 'consumerClientPID'], registry=REGISTRY)
    gauge_msg_diff_topic = Gauge("rocketmq_msg_diff_topic", "message count that not be consumed.", ['topic'], registry=REGISTRY)
    gauge_msg_diff_consumergroup = Gauge("rocketmq_msg_diff_consumergroup", "message count that not be consumed.", ['consumerGroup'], registry=REGISTRY)
    gauge_msg_diff_topic_consumergroup = Gauge("rocketmq_msg_diff_topic_consumergroup", "message count that not be consumed.", ['topic', 'consumerGroup'], registry=REGISTRY)
    gauge_msg_diff_broker = Gauge("rocketmq_msg_diff_broker", "message count that not be consumed.", ['broker'], registry=REGISTRY)
    gauge_msg_diff_queue = Gauge("rocketmq_msg_diff_queue", "message count that not be consumed.", ['broker', 'queueId'], registry=REGISTRY)
    gauge_msg_diff_clientinfo = Gauge("rocketmq_msg_diff_clientinfo", "message count that not be consumed.", ['consumerClientIP', 'consumerClientPID'], registry=REGISTRY)
